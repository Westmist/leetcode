...
//     */
//    @Title("删除链表中的节点")
//    @Convert(value = "[4,5,1,9]", convert = ListNodeListConvert.class, genericType = Integer.class, cvtIndex = {1})
...
//     */
//    @Title("删除链表的倒数第N个节点")
//    @Convert(value = {"[1,2,3,4,5]", "2"}, convert = ListNodeConvert.class, genericType = {Integer.class})
...
//     */
//    @Title("反转链表")
//    @Convert(value = "[1,2]", convert = ListNodeConvert.class, genericType = Integer.class)
...
//     */
//    @Title("合并两个有序链表")
//    @Convert(value = {"[1,2,4]", "[1,3,4]"}, convert = {ListNodeConvert.class, ListNodeConvert.class},
...
//     */
//    @Title("回文链表")
//    @Convert(value = "[1,2,2,1]", convert = ListNodeConvert.class, genericType = Integer.class)
//    @Answer(value = "true")
